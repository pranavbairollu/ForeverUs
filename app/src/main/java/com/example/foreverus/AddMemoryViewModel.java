...
public class AddMemoryViewModel extends AndroidViewModel {
    ...
    public void saveMemory(java.util.List<Uri> imageUris, String mimeType, String title, String description,
            String location, String relationshipId, FirebaseUser user, String audioFilePath) {
    ...
    public void saveMemory(java.util.List<Uri> imageUris, String mimeType, String title, String description,
            String location, String relationshipId, FirebaseUser user) {
        saveMemory(imageUris, mimeType, title, description, location, relationshipId, user, null);
    }

    public void saveMemory(Uri imageUri, String mimeType, String title, String description, String location,
            String relationshipId, FirebaseUser user) {
    ...
    private boolean isNetworkAvailable() {
        android.net.ConnectivityManager connectivityManager = (android.net.ConnectivityManager) getApplication()
    ...
    private void uploadMediaToCloudinary(java.util.List<Uri> uris, String mimeType, String title, String description,
            String location, String relationshipId, FirebaseUser user, String audioFilePath) {
        initCloudinary();
            ...
            com.cloudinary.android.MediaManager.get().upload(uri)
                    ...
                    .callback(new com.cloudinary.android.callback.UploadCallback() {
                        ...
                        public void onSuccess(String requestId, java.util.Map resultData) {
                            ...
                            checkCompletionRecursive(totalItems, successCount.incrementAndGet(), failureCount.get(),
                                    uploadedUrls, uploadedAudioUrl[0], finalResourceType, title, description, location,
                                    relationshipId, user);
                        }
                        ...
                        public void onError(String requestId, com.cloudinary.android.callback.ErrorInfo error) {
                            ...
                            checkCompletionRecursive(totalItems, successCount.get(), failureCount.incrementAndGet(),
                                    uploadedUrls, uploadedAudioUrl[0], finalResourceType, title, description, location,
                                    relationshipId, user);
                        }
    ...
    private void checkCompletionRecursive(int total, int success, int failure, java.util.List<String> urls,
            String audioUrl, String mediaType, String title, String description, String location, String relationshipId,
            FirebaseUser user) {
    ...
    private void saveMemoryToRepository(java.util.List<String> mediaUrls, String audioUrl, String mediaType,
            String title, String description, String location, String relationshipId, FirebaseUser user) {
        ...
        memoryRepository.saveMemory(memory, new TimelineRepository.Callback() {
            ...
            public void onError(Exception e) {
                ...
                // 1. If Offline/Unavailable -> It saved locally in repo, but called onError
                ...
                if (e instanceof com.google.firebase.firestore.FirebaseFirestoreException &&
                    ...
                    // For now, let's play safe and say "Saved to device" if it's not a fundamental
                    // crash.
