...
public class LetterViewActivity extends BaseActivity {
    ...
    private void handleLetter(Letter letter) {
        ...
        if (isLocked) {
            ...
            SimpleDateFormat sdf = new SimpleDateFormat(getString(R.string.date_format_month_day_year), Locale.getDefault());
            ...
            binding.btnOpenSeal.setBackgroundTintList(android.content.res.ColorStateList.valueOf(getColor(android.R.color.holo_red_dark)));
                    ...
                    .withEndAction(() -> {
                         binding.envelopeOverlay.animate()
                             ...
                             .withEndAction(() -> {
                                 ...
                                 if (petals != null) petals.startShower();
            ...
            if (letter.getTimestamp() != null) {
                SimpleDateFormat sdf = new SimpleDateFormat(getString(R.string.date_format_month_day_year), Locale.getDefault());
                binding.letterDateTextView.setText(getString(R.string.sent_on_date, sdf.format(letter.getTimestamp().toDate())));
            }
    ...
    private void stopPlaying() {
        if (mediaPlayer != null) {
            mediaPlayer.stop();
            // Don't release, reuse or release in onStop
            mediaPlayer.reset();
        }
        isPlaying = false;
    ...
    private void handleIntimacyFeatures(Letter letter) {
        ...
        if (isSender && letter.getReadTimestamp() != null) {
             ...
             // User requested poetic status. Let's append to Date for now as there isn't a dedicated ReadStatus View in my XML edit yet.
             // Actually, I didn't add a ReadStatus TextView in XML. I'll add it programmatically or append to existing.
        ...
        if (isReceiver) {
            ...
            if (letter.getReaction() != null) {
                for (int i = 0; i < binding.reactionChipGroup.getChildCount(); i++) {
                     com.google.android.material.chip.Chip chip = (com.google.android.material.chip.Chip) binding.reactionChipGroup.getChildAt(i);
            ...
            if (letter.getReaction() != null) {
                ...
                // "Partner reacted"
                binding.reactionStatusText.setText(getString(R.string.partner_reacted_status, "Partner")); // Use string resource or hardcode for now
    ...
    private String getPoeticReadTime(Date date) {
        ...
        if (minutes < 1440) return "Opened today";
